                                        ...
                                        <form id="reg-form" class="form-default" role="form"
                                            ...
                                            <div class="form-group">
                                                <label for="account_type"
                                                    class="fs-12 fw-700 text-soft-dark">{{ translate('Account type') }}</label>
                                                <select id="account_type"
                                                    class="form-control rounded-0{{ $errors->has('account_type') ? ' is-invalid' : '' }}"
                                                    name="account_type" required>
                                                    <option value="commercial">{{ translate('Commercial Account') }}
                                                    </option>
                                            ...
                                            <div id="categories" class="form-group">
                                                <label for="category_id"
                                                    class="fs-12 fw-700 text-soft-dark">{{ translate('Category type') }}</label>
                                            ...
                                            <div id="services" class="form-group" style="display:none;">
                                                <label for="service_id"
                                                    class="fs-12 fw-700 text-soft-dark">{{ translate('Services') }}</label>
