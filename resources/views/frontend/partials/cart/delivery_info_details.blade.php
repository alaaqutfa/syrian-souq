<div class="row gutters-16">
    ...
    @endphp
    <!-- Product List -->
    <div class="{{ get_setting('shipping_type') != 'area_wise_shipping' ? $col_val : 'col' }}">
    ...
    @if ($physical)
        ...
        <div class="col-md-6 mb-2 @if (get_setting('shipping_type') == 'area_wise_shipping') d-none @endif">
            <h6 class="fs-14 fw-700 mt-3">
                @if (get_setting('shipping_type') == 'carrier_wise_shipping')
                    {{ translate('Choose the delivery location') }}
                @else
