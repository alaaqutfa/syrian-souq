            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <h3 class="mb-0 text-white fs-30">
                            {{ \App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status',
                            'delivered')->count() }}
                        </h3>
                    </div>
                    <div class="col-auto text-right">
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col">
                        ...
                        <h3 class="mb-0" style="color: #A9A3CC">
                            {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status',
                            'pending')->count() }}
                        </h3>
                    </div>
                </div>
    ...
    <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
        ...
        <div
            ...
            <div class="my-n4 py-1 text-center">
                ...
                {{-- <a href="{{ route('seller.shop.verify') }}" class="btn btn-sm btn-primary">{{ translate('Verify
                    Now') }}</a> --}}
            </div>
            @else
            <div class="my-2 py-1">
